...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className={`${milker.variable} ${gondens.variable} font-sans text-zinc-700 antialiased selection:bg-green-500/30 selection:text-green-900 bg-zinc-50 relative`}>
