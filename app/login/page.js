  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20 px-6 bg-transparent">
      <div className="w-full max-w-md clay-card rounded-[2rem] p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-green-400 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob"></div>
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-green-200 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-2000"></div>
        
        <div className="relative z-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-black text-zinc-800 font-[family-name:var(--font-body)] tracking-tight">Welcome Back</h1>
